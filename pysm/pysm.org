...
#+RESULTS:
[[file:./.ob-jupyter/1c7088401a5a67c0df0b76afd7206cd9968adeaf.png]]
...
Rotate mask into galactic coordinates and apply 5 degrees smoothing
#+BEGIN_SRC jupyter-python
  input_map = galactic_mask*survey_mask
  mask = pysm.apply_smoothing_and_coord_transform(input_map, rot=hp.Rotator(coord="EG"), fwhm=5*u.deg)
  hp.mollview(mask, title=None)
#+END_SRC

#+RESULTS:
[[file:./.ob-jupyter/377c1b597663c7f2d30f21fb2ba69e565b543b04.png]]

Let's try to mask the dust emission for instance and see the remanant emission at 100 GHz
#+BEGIN_SRC jupyter-python
  sky = pysm.Sky(nside=1024, preset_strings=["d1"], output_unit=u.uK_CMB)
  map_100GHz = sky.get_emission(100 * u.GHz)
  hp.mollview(mask * map_100GHz[0])
#+END_SRC

#+RESULTS:
[[file:./.ob-jupyter/10d0fe1603543b75430d42c48cab1d6b3034e9b0.png]]

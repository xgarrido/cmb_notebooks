...
# Out[54]:
: Text(0, 0.5, '$D_\\ell$')
[[file:./obipy-resources/7qJScf.png]]
:end:
...
pretty straightforward. We first install it
#+BEGIN_SRC
...
:results:
# Out[72]:
: <matplotlib.legend.Legend at 0x7f504d97d7b8>
[[file:./obipy-resources/QyvXtH.png]]
:end:
